  ...
  instance = new ImageEditor(
    document.querySelector("#tui-image-editor"),
    {
      includeUI: {
        ...
        locale: window.localStorage.getItem('languageType') != 'zh' || !window.localStorage.getItem('languageType') ? '' : locale_zh, // 本地化语言为中文
...
watch(
  () => window.localStorage.getItem('languageType'),
  (newValue, oldValue) => {
    onMounted()
  }
);
